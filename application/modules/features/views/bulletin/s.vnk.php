    ...
    <body id="gradient">
        <div class="container-fluid">
            <div class="row">
                ...
                <div id="newsByCat1" class="col-md-2 col-sm-2 col-xs-12"></div>
                <div id="newsByCat2" class="col-md-2 col-sm-2 col-xs-12"></div>
                <div id="newsByCat3" class="col-md-2 col-sm-2 col-xs-12"></div>
                <div class="col-md-3 col-sm-3 col-xs-12">
